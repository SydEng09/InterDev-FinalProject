...
namespace ServiceSystem.DAL
{
    internal partial class eBikeServiceContext : DbContext
    {
        public eBikeServiceContext()
        {
        }

        public eBikeServiceContext(DbContextOptions<eBikeServiceContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UnorderedPurchaseItemCart>(entity =>
            {
                entity.HasKey(e => e.CartID)
                    .HasName("PK__Unordere__51BCD79788AD4B5C");
            });
